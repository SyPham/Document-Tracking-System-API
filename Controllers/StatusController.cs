...
namespace DTS_API.Controllers
{
    ...
    {
        private readonly IStatusService _teamService;
        public StatusController(IStatusService teamService)
        {
            _teamService = teamService;
        }

        [HttpGet("{langID}")]
        public async Task<IActionResult> GetStatuss([FromQuery]PaginationParams param, string langID)
        {
